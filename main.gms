...
$setglobal cm_taxrc_RE  REdirect "switch to define whether tax on (CO2 content of) energy imports is recycled as additional direct investments in renewables" !! " def = none
